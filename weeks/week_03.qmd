...
-   Data visualization, exploratory data analysis (EDA), and summarizing categorical data
    ...
    -   Below I posted additional "__Day 3 part 3__" slides with extra data wrangling code. I refer to some of the slides in the homework assignment. You are welcome to go through all of the slides to learn some data wrangling techniques. We will be covering topics from these slides as needed throughout the quarter. 
    -   Bonus: 
